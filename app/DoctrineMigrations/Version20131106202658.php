...
class Version20131106202658 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE TABLE request (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, id_admin INT DEFAULT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL, state INT NOT NULL, pdf VARCHAR(200) DEFAULT NULL, comment VARCHAR(300) NOT NULL, number_of_working_days INT DEFAULT NULL, INDEX IDX_3B978F9FA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
